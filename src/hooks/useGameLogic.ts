...
const DIFFICULTY_CONFIG: Record<Difficulty, DifficultyConfig> = {
  facile: { minMines: 2, maxMines: 4, baseMultiplier: 1.0, multiplierIncrement: 0.12 },
  moyen: { minMines: 5, maxMines: 8, baseMultiplier: 1.0, multiplierIncrement: 0.25 },
  difficile: { minMines: 10, maxMines: 15, baseMultiplier: 1.0, multiplierIncrement: 0.5 },
};
