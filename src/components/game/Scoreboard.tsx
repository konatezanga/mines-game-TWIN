  ...
  return (
    <div className="glass-panel p-4 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          <div className="flex items-center justify-center gap-2 text-muted-foreground mb-1">
            ...
            <span className="text-xs uppercase tracking-wider">Multiplicateur</span>
          </div>
          <AnimatePresence mode="wait">
            <motion.div
              key={multiplier}
        ...
        <div className="bg-muted/30 rounded-lg p-3 text-center">
          <div className="flex items-center justify-center gap-2 text-muted-foreground mb-1">
            ...
            <span className="text-xs uppercase tracking-wider">Trouvé</span>
          </div>
      ...
      {gameState === 'playing' && (
        ...
        >
          <span className="text-xs text-success">
            {safeTilesRemaining} cases restantes
          </span>
        </motion.div>
      )}
      ...
      {gameState === 'lost' && (
        ...
        >
          <span className="text-destructive font-semibold">💥 Vous avez touché une mine!</span>
        </motion.div>
      )}
      ...
      {gameState === 'won' && (
        ...
        >
          <span className="text-success font-semibold">
            🎉 Retiré avec {points.toLocaleString()} points!
          </span>
        </motion.div>
      )}
    </div>
